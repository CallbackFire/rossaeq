...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url() ?>assets/custom_rossaeq.min.css" rel="stylesheet">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-home"></i> Real Estate <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url() ?>for_rent_entry_list">For Rent</a></li>
                  ...
                  <li><a href="javascript:void(0)"><i class="fa fa-laptop"></i> Social Media <span class="label label-success pull-right">Coming Soon</span></a></li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url() ?>uploads/admin_profiles/one.jpg" alt=""> Francis
        ...
        <footer>
          <div class="pull-right">
            Rossaeq Admin by - <a href="https://lembacode.com">lemba.io</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script src="<?php echo base_url() ?>assets/custom_rossaeq.min.js"></script>
  </body>
</html>
